...
def test_agente(agente, lista_mensajes=mensajes_del_usuario):
    """
    ...
    for consulta in lista_mensajes:
        resultado_agente = agente.consultar(consulta)
        resultados.append(resultado_agente)
    
    # Visualizar lista como un único JSON en consola
